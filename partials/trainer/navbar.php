...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" id="dashboardLink" href="/thikatechinical-personalised-time-management-system/trainer/dashboard.php">
    ...
    <a class="nav-link" href="/thikatechinical-personalised-time-management-system/student/notifications.php">
        ...
        <?php if ($unread_count > 0): ?>
            <span class="blink bi bi-bell" style="color: red; background-color: wheat; margin-left: 5px;"><?php echo $unread_count; ?></span>
        <?php endif; ?>
    </a>
</li>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/thikatechinical-personalised-time-management-system/trainer/checkin.php">
